...
- **Relationship-heavy roles** (sales, recruiting, partnerships, account management, fundraising) — jobs cluster around knowing the state of a set of counterparties. `people/` is load-bearing, and the evidence is mostly what someone said and when.
