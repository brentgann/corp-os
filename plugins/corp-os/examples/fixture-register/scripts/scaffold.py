...
SHIPPED = ("build_index.py", "check_connector.py", "source_yield.py", "friction_scan.py", "propose.py", "prune_config_notes.py", "file_raw.py", "write_export.py", "log_run.py",
